...
/* Copyright (C) 2014 Juan Antonio Puchol Garc�a
 * Depto. Ciencia de la Computaci�n e Inteligencia Artificial
 * Universidad de Alicante
 * 
 * M�ster Universitario en Desarrollo de Software para Dispositivos M�viles
 */
...
public class Resource3DSReader {
	...
	// N�mero m�ximo de mallas de triangulos a leer
